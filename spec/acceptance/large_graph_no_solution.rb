...
DEMANDS = ["[\"nodejs\", #<Solve::Constraint = 0.1.0>]",
           "[\"rabbitmq\", #<Solve::Constraint = 0.1.0>]",
           "[\"sensu\", #<Solve::Constraint = 0.1.0>]",
           "[\"annoyances\", #<Solve::Constraint = 1.0.1>]",
           "[\"apt\", #<Solve::Constraint = 2.3.9>]",
           "[\"ark\", #<Solve::Constraint = 0.7.3>]",
           "[\"avahi-daemon\", #<Solve::Constraint = 0.0.14>]",
           "[\"aws\", #<Solve::Constraint = 2.1.2>]",
           "[\"chef-server\", #<Solve::Constraint = 2.1.5>]",
           "[\"chef_handler\", #<Solve::Constraint = 1.1.5>]",
           "[\"dmg\", #<Solve::Constraint = 2.1.5>]",
           "[\"dynect\", #<Solve::Constraint = 1.0.5>]",
           "[\"ec2\", #<Solve::Constraint >= 0.0.0>]",
           "[\"elasticsearch\", #<Solve::Constraint = 0.3.8>]",
           "[\"ganglia\", #<Solve::Constraint = 0.2.1>]",
           "[\"git\", #<Solve::Constraint = 2.8.5>]",
           "[\"graphite\", #<Solve::Constraint = 0.4.8>]",
           "[\"homebrew\", #<Solve::Constraint = 1.5.5>]",
           "[\"ircd-ratbox\", #<Solve::Constraint >= 0.0.0>]",
           "[\"java\", #<Solve::Constraint = 1.22.1>]",
           "[\"jenkins\", #<Solve::Constraint = 2.0.3>]",
           "[\"kibana\", #<Solve::Constraint = 0.1.7>]",
           "[\"logstash\", #<Solve::Constraint = 0.7.6>]",
           "[\"minitest-handler\", #<Solve::Constraint = 1.1.5>]",
           "[\"monit\", #<Solve::Constraint = 0.7.3>]",
           "[\"mysql\", #<Solve::Constraint = 5.0.3>]",
           "[\"nginx\", #<Solve::Constraint = 2.5.1>]",
           "[\"ntp\", #<Solve::Constraint = 1.6.3>]",
           "[\"omnibus_updater\", #<Solve::Constraint = 1.0.0>]",
           "[\"openswan\", #<Solve::Constraint = 0.3.0>]",
           "[\"openvpn\", #<Solve::Constraint = 3.0.1>]",
           "[\"php\", #<Solve::Constraint = 1.4.7>]",
           "[\"postfix\", #<Solve::Constraint = 3.0.5>]",
           "[\"postgresql\", #<Solve::Constraint = 3.3.4>]",
           "[\"powershell\", #<Solve::Constraint = 3.0.1>]",
           "[\"python\", #<Solve::Constraint = 1.4.7>]",
           "[\"rbenv\", #<Solve::Constraint = 1.7.1>]",
           "[\"rsyslog\", #<Solve::Constraint = 1.12.3>]",
           "[\"ruby_build\", #<Solve::Constraint = 0.8.1>]",
           "[\"runit\", #<Solve::Constraint = 1.5.11>]",
           "[\"rvm\", #<Solve::Constraint = 0.9.2>]",
           "[\"statsd\", #<Solve::Constraint = 1.1.5>]",
           "[\"sysctl\", #<Solve::Constraint = 0.3.5>]",
           "[\"ubuntu\", #<Solve::Constraint = 1.1.7>]",
           "[\"vagrant-cookbook\", #<Solve::Constraint = 0.2.0>]",
           "[\"varnish\", #<Solve::Constraint = 0.9.13>]",
           "[\"vim\", #<Solve::Constraint = 1.1.3>]",
           "[\"virtualbox-cookbook\", #<Solve::Constraint = 1.0.3>]",
           "[\"windows\", #<Solve::Constraint = 1.30.1>]",
           "[\"yum\", #<Solve::Constraint = 2.4.5>]"]
ARTIFACTS = 
{"nodejs"=>
